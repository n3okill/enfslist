...
function list(path, opt) {
    ...
    const showStats = options.stats && Array.isArray(options.stats) && options.stats.length ? options.stats : Object.getOwnPropertyNames(stats2).concat(Object.getOwnPropertyNames(Object.getPrototypeOf(stats2)));
